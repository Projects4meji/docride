  ...
  return (
    <Box sx={{ bgcolor: "#F8F8F8", minHeight: "100vh" }}>
      ...
      >
        ...
        >
          Hey, ever heard of RIDDOR? It might sound like something from a sci-fi
          flick, but it’s actually a key part of keeping workplaces safe in the
          UK. RIDDOR stands for the{" "}
          ...
          work, you’ve got to tell the Health and Safety Executive (HSE).” Why?
          Because reporting these incidents helps spot problems, fix them, and
          make sure fewer people get hurt. Let’s dive in and break it
          down—because trust me, you don’t want to skip this and end up in hot
          water!
        </Typography>
        ...
        >
          Picture this: a worker slips off a ladder, or a gas leak nearly turns
          a quiet day into a disaster. RIDDOR is the system that makes sure
          these incidents don’t just get swept under the rug. Enforced by the
          HSE (the UK’s workplace safety pros), it’s been around since the
        ...
        >
          ...
          stubbed toes—it’s focused on the big stuff that can really mess things
        ...
        <Box sx={{}}>
          ...
          <Box component="ul" sx={{ mb: 3 }}>
            ...
            <Box component="li">
              A biological agent escaping that might cause a serious infection.
              They’re reportable because they’re red flags—fix it now, or
          ...
          >
            Reporting these keeps the HSE in the loop, helping them spot trends
            and crack down on safety risks.
          </Typography>
        </Box>
        {/* Image & Text Layout */}
        <Box
            ...
            <TableBody>
              {[
                ...
                <TableRow key={idx} hover>
                  ...
                  <TableCell sx={{ textAlign: "center" }}>{row.how}</TableCell>
                  <TableCell sx={{ textAlign: "center" }}>{row.when}</TableCell>
                  <TableCell
                    sx={{
                      textAlign: "center",
                      fontWeight: "bold",
        ...
        >
          ...
          scaffolds keep collapsing or asthma’s spiking in factories. That info
          leads to better rules and safer workplaces. So, when you report,
          you’re not just saving your own skin—you’re looking out for everyone.
        </Typography>
        ...
        >
          ...
          serious stuff, from injuries to those heart-stopping near-misses (yep,
          those dangerous occurrences!), and making sure the HSE knows about it.
          Reporting’s easy, the deadlines are clear, and the stakes are high if
          you skip it. So, next time something goes sideways at work, don’t
